...
final class TranslationDto {
  ...
  factory TranslationDto.fromJson(JsonMap json) {
  ...
  final TranslationTranslatedNameDto? translatedName;
  ...
  static TranslationTranslatedNameDto? _translatedName(Object? value) {
    if (value is! JsonMap) {
      return null;
    }
    ...
    return TranslationTranslatedNameDto(
      name: name,
...
@immutable
final class TranslationTranslatedNameDto {
  const TranslationTranslatedNameDto({required this.name, this.languageName});
...
@immutable
final class TranslationTextDto {
  const TranslationTextDto({
  ...
  factory TranslationTextDto.fromJson(JsonMap json) {
    return TranslationTextDto(
